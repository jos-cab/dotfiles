...
hl.bind(mainMod .. " + ALT + H", hl.dsp.window.move({ x = -20, y = 0 }), { repeating = true })
hl.bind(mainMod .. " + ALT + J", hl.dsp.window.move({ x = 0, y = 20 }),  { repeating = true })
hl.bind(mainMod .. " + ALT + K", hl.dsp.window.move({ x = 0, y = -20 }), { repeating = true })
hl.bind(mainMod .. " + ALT + L", hl.dsp.window.move({ x = 20, y = 0 }),  { repeating = true })
...
-- Adjust gaps
hl.bind(mainMod .. " + minus",        hl.dsp.exec_cmd("~/.config/hypr/scripts/adjust_gaps out dec"))
hl.bind(mainMod .. " + plus",         hl.dsp.exec_cmd("~/.config/hypr/scripts/adjust_gaps out inc"))
hl.bind(mainMod .. " + SHIFT + minus",hl.dsp.exec_cmd("~/.config/hypr/scripts/adjust_gaps in dec"))
hl.bind(mainMod .. " + SHIFT + plus", hl.dsp.exec_cmd("~/.config/hypr/scripts/adjust_gaps in inc"))
...
hl.bind(mainMod .. " + ALT + Up",    hl.dsp.window.resize({ x = 0, y = -20 }), { repeating = true })
hl.bind(mainMod .. " + ALT + Down",  hl.dsp.window.resize({ x = 0, y = 20 }),  { repeating = true })
hl.bind(mainMod .. " + ALT + Left",  hl.dsp.window.resize({ x = -20, y = 0 }), { repeating = true })
hl.bind(mainMod .. " + ALT + Right", hl.dsp.window.resize({ x = 20, y = 0 }),  { repeating = true })

hl.bind(mainMod .. " + CTRL + Up",    hl.dsp.window.move({ x = 0, y = -20 }), { repeating = true })
hl.bind(mainMod .. " + CTRL + Down",  hl.dsp.window.move({ x = 0, y = 20 }),  { repeating = true })
hl.bind(mainMod .. " + CTRL + Left",  hl.dsp.window.move({ x = -20, y = 0 }), { repeating = true })
hl.bind(mainMod .. " + CTRL + Right", hl.dsp.window.move({ x = 20, y = 0 }),  { repeating = true })
